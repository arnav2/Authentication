...
export class DefaultApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * Delete User
     */
    public async authDeleteDelete(_options?: Configuration): Promise<RequestContext> {
    ...
    public async authRegisterPost(authLoginPostRequest: AuthLoginPostRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'authLoginPostRequest' is not null or undefined
        if (authLoginPostRequest === null || authLoginPostRequest === undefined) {
            throw new RequiredError("DefaultApi", "authRegisterPost", "authLoginPostRequest");
        }
...
export class DefaultApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to authDeleteDelete
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async authDeleteDeleteWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
        if (isCodeInRange("401", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "Unauthorized - Missing or invalid token", undefined, response.headers);
        }
